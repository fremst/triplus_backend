...
public class CreateJWT {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        CreateJWT testJWT = new CreateJWT();
        String token = testJWT.createToken("test");
        System.out.println(token);



        Map<String, Object> claimMap = testJWT.verifyJWT(token);
    ...
    public String createToken(String id) {
        ...
        Long expiredTime = 1000 * 60L * 60L * 10L; // 토큰 유효 시간 (10시간)
